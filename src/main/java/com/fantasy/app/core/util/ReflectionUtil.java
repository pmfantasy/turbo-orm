...
public class ReflectionUtil {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static List<Field> getDeclaredFieldsCasecade(Class clazz) {
	...
	public static String toString(Object obj) {
		...
		for (Field f : fields) {
			String filedName = f.getName();
			sb.append(filedName + " = " + getFieldValue(obj, filedName) + ",");
		}
		return className + " => [" + sb.toString().substring(0, sb.toString().length() - 1) + "]";
	}

	/**
	 * 获取toString方法字符串
	 * return "Object [filed=" + filed + ", filed1=" + filed1 + "]";
	 * @param obj
	 * @return
	 */
	@SuppressWarnings("rawtypes")
	public static String getToString(Class clazz) {
		StringBuffer sb = new StringBuffer("");
