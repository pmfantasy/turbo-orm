...
//		String input = "测试解码钱内容dsfasdfsda";//"040000101002_10.10.116.74_20140101110000";
//		System.out.println("base64:\n"+base64Encode(input.getBytes()));
//		System.out.println("base64 end...");
//		System.out.println("hex:\n"+hexEncode(input.getBytes()));
//		System.out.println("hex end...");
//		System.out.println("url:\n"+urlEncode(input));
//		System.out.println("url end...");
//		System.out.println("base64Encode:\n"+base64UrlSafeEncode(input.getBytes()));
//		System.out.println("base64Encode end...");
//		//url
//	}
}
